...
export default function TroubleshootPage() {
  ...
  // Without this, typing in the free-text input overwrote the '__other' sentinel
  // and unmounted the input mid-keystroke, resetting the form.
      ...
      <div className="page">
        <div className="stack">
          ...
          {followUps.length > 0 && (
            <div className="stack-sm">
              {followUps.map((fu, i) => (
                <div key={i} className="card" style={{ background: 'rgba(20,184,166,0.06)' }}>
          ...
          {sessionId && (
            <form onSubmit={handleFollowUp} className="stack-sm">
              ...
              <textarea
                ...
                placeholder="e.g. Chlorine still low after shock — what else?"
                rows={2}
              />
              <button
                type="submit"
