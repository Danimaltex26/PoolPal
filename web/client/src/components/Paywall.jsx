...
export default function Paywall() {
  ...
  const defaultOffering = offerings?.all?.['PoolPal'];
        ...
        {annualPkg && (
          <button
            ...
            style={{
              ...
              padding: '1rem',
              borderRadius: 12,
              border: selected === 'Annual' ? '2px solid #14B8A6' : '2px solid #2A2A2E',
              background: selected === 'Annual' ? 'rgba(20,184,166,0.08)' : 'transparent',
              cursor: 'pointer',
              textAlign: 'center',
              position: 'relative',
            }}
          >
            ...
            <p style={{ fontSize: '1.25rem', fontWeight: 700, color: '#14B8A6', margin: '0.25rem 0' }}>
        ...
        {monthlyPkg && (
          <button
            ...
            style={{
              ...
              padding: '1rem',
              borderRadius: 12,
              border: selected === 'Monthly' ? '2px solid #14B8A6' : '2px solid #2A2A2E',
              background: selected === 'Monthly' ? 'rgba(20,184,166,0.08)' : 'transparent',
              cursor: 'pointer',
              textAlign: 'center',
            }}
          >
