// Generate and seed training content for PoolPal via Claude API
...
async function main() {
  console.log("=== Seeding PoolPal Training Content ===\n");
