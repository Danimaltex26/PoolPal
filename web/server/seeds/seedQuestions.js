// Generate and seed training questions for PoolPal via Claude API
...
async function main() {
  console.log("=== Seeding PoolPal Training Questions ===\n");
